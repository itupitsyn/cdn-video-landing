...
const Feature: FC<FeatureProps> = ({ text }) => {
  return (
    <div className={cn('relative flex h-45.75 flex-col overflow-hidden rounded-[40px]')}>
      <div
        className={cn(
      ...
      />
      <div className="flex grow flex-col justify-end rounded-[39px] px-4 py-5">
...
export const Features: FC = () => {
  return (
    <section className="container grid grid-cols-2 gap-x-3 gap-y-2.5 pt-7.5">
