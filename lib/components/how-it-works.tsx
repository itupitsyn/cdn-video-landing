...
export const HowItWorks: FC = () => {
  return (
    <section className="container pt-27.5">
      ...
      <p className="leading-pup hidden pt-7.5 text-center whitespace-pre sm:block">
        {'Подключение не требует перестройки сайта\nили собственной рекламной инфраструктуры'}
      </p>

      <div className="grid grid-cols-2 gap-x-3 gap-y-2.5 pt-7.5 sm:pt-12.5">
      ...
      <div className="flex flex-col items-center pt-5 sm:pt-7.5">
        <SendRequestLink />
      </div>
    </section>
  );
