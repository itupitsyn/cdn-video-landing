    ...
    <div className="absolute inset-0 -z-1 overflow-hidden">
      <div className="relative container h-full w-full">
        ...
        <Image
          src={BG1Huge}
          alt=""
          className="absolute top-229.25 -left-162.75 hidden h-375 w-360.5 2xl:block"
          width={3101}
          height={2983}
        />
        ...
        <Image
          src={BG2Huge}
          alt=""
          className="absolute top-291.25 left-119.5 hidden h-325.25 w-387.5 2xl:block"
          width={3185}
          height={2716}
        />
        ...
        <Image
          src={BG3Huge}
          alt=""
          className="absolute top-389.75 -left-51.25 hidden size-575 2xl:block"
          width={4654}
          height={4654}
        />
        ...
        <Image
          src={BG4Huge}
          alt=""
          className="absolute top-1088.25 left-152 hidden h-373.5 w-532.75 rotate-12 2xl:block"
          width={4262}
          height={2988}
        />
      </div>
